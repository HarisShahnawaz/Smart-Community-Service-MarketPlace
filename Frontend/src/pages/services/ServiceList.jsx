      ...
      <div className={`md:w-64 flex-shrink-0 ${isFilterOpen ? 'block' : 'hidden md:block'}`}>
        <div className="bg-beige-50 dark:bg-dark-surface rounded-2xl p-6 border border-beige-300 dark:border-dark-border sticky top-24">
          ...
          <form onSubmit={handleSearchSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="radio" name="category" value="" checked={category === ''} onChange={() => setCategory('')} className="text-teal-600 dark:text-dark-brand focus:ring-teal-500 dark:focus:ring-dark-brand bg-white dark:bg-dark-surface-elevated border border-beige-300 dark:border-dark-border" />
                  <span className="text-sm text-charcoal dark:text-dark-text-secondary">All Categories</span>
                </label>
                {CATEGORIES.map(cat => (
                  <label key={cat} className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="category" value={cat} checked={category === cat} onChange={() => setCategory(cat)} className="text-teal-600 dark:text-dark-brand focus:ring-teal-500 dark:focus:ring-dark-brand bg-white dark:bg-dark-surface-elevated border border-beige-300 dark:border-dark-border" />
            ...
            <div>
              <label className="block text-sm font-medium text-charcoal dark:text-dark-text-secondary mb-2">Starting Price ($)</label>
