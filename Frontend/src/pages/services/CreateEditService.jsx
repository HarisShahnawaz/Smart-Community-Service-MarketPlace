    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-sm border border-slate-200 dark:border-dark-border overflow-hidden">
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
          ...
          {/* Title */}
          <div>
            <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Service Title</label>
            <input
              type="text"
              name="title"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div>
              <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Starting Price ($)</label>
              <input
                type="number"
                name="price"
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Delivery Time (Days)</label>
              <input
                type="number"
          ...
          {/* Availability Toggle */}
          <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-dark-bg border border-slate-200 dark:border-dark-border rounded-xl">
            <input
              type="checkbox"
              id="availability"
              name="availability"
              ...
              onChange={handleChange}
              className="w-5 h-5 text-brand-600 border-slate-400 dark:border-slate-600 rounded focus:ring-brand-500 cursor-pointer"
            />
            <label htmlFor="availability" className="font-medium text-slate-700 dark:text-slate-300 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Upload examples of your past work to attract more clients.</p>
